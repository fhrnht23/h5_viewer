...
_RU: dict[str, str] = {
    ...
    "Dtype": "Тип данных",
    "Storage": "Хранение",
    "Logical size": "Логический размер",
    "On disk": "На диске",
    "B": "Б",
    "KiB": "КиБ",
    "MiB": "МиБ",
    ...
    "Property": "Свойство",
    "Value": "Значение",
    "Attribute count": "Количество атрибутов",
    "File size": "Размер файла",
    "Driver": "Драйвер",
    "HDF5 library bounds": "Границы версии библиотеки HDF5",
    "User block size": "Размер пользовательского блока",
    "HDF5 version": "Версия HDF5",
    "h5py version": "Версия h5py",
    "Direct members": "Объектов непосредственно в группе",
    "Rank": "Ранг",
    "Compression options": "Параметры сжатия",
    "Scale-offset filter": "Фильтр scale-offset",
    "Virtual dataset": "Виртуальный набор данных",
    "Dimension scale": "Шкала измерения",
    "External raw storage": "Внешнее хранение данных",
    "Filter identifiers": "Идентификаторы фильтров",
    "Filter names": "Названия фильтров",
    "Virtual sources": "Виртуальные источники",
    "Dimension labels": "Метки измерений",
    "Unique datasets recursively": "Уникальных datasets рекурсивно",
    "Unique groups recursively": "Уникальных групп рекурсивно",
    "Recursive logical size": "Рекурсивный логический размер",
    "Recursive size on disk": "Рекурсивный размер на диске",
    "Aliases and cycles excluded": "Исключено дубликатов и циклов",
    "External links skipped": "Пропущено внешних ссылок",
    "Unresolved links": "Неразрешённых ссылок",
    "Virtual datasets": "Виртуальных datasets",
    "Calculate recursive size…": "Рассчитать рекурсивный размер…",
    "Calculating recursive group size…": "Расчёт рекурсивного размера группы…",
    "Group size": "Размер группы",
    "Size calculation cancelled": "Расчёт размера отменён",
    "Group size calculated": "Размер группы рассчитан",
    (
        "The calculation counts unique dataset payloads; HDF5 metadata, attributes "
        "and external links are not included."
    ): (
        "Подсчёт учитывает данные уникальных datasets; метаданные HDF5, атрибуты "
        "и внешние ссылки не включаются."
    ),
    "Datasets: {datasets} · Logical: {logical} · On disk: {storage}": (
        "Datasets: {datasets} · логический размер: {logical} · на диске: {storage}"
    ),
    "Add": "Добавить",
    "Change": "Изменить",
    "Delete": "Удалить",
