...
- открывать отдельный инспектор объекта клавишей `Enter`, сохраняя всю высоту основного окна панелям;
- показывать краткие сведения о выбранном объекте в строке состояния;
...
- загружать изолированные расширения через версионированный Python entry-point API.
...
Разработка расширений и установка готового примера описаны в [docs/plugins.md](docs/plugins.md).
